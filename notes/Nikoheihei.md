...
为什么agent需要有钱：支付调用api的费用（比如太多平台记不住，而且金额小）

financial harness：sandbox. 1.rule-based filtering 2.intent matching 3.model evaluation（agent supervises agent）

支付的一个可能方向：claude去找数据端点然后做交易
<!-- DAILY_CHECKIN_2026-06-06_END -->

# 2026-06-04
<!-- DAILY_CHECKIN_2026-06-04_START -->

VC的投资越来越务实：看落地，看闭环，留存率。时机，学习速度，落地速度很重要。

VC融资的理由：后期规模化？

![截屏2026-06-04 22.08.01.png](https://raw.githubusercontent.com/IntensiveCoLearning/AI-Web3-School/main/assets/Nikoheihei/images/2026-06-04-1780582084821-__2026-06-04_22.08.01.png)

VC早期看重人：靠谱，行业理解深度，虚心（尤其web3这种变化快的），凝聚力互补性。加分项：connection+创始人个人魅力（节省marketing费用+社区力量）。
