...
1、按照andrej karpathy llm wiki方法， 用obsidian等工具整理知识流

相关技巧：

A useful tip: if each entry starts with a consistent prefix (e.g. `## [2026-04-02] ingest | Article Title`), the log becomes parseable with simple unix tools — `grep "^## \[" log.md | tail -5` gives you the last 5 entries.
