...
**白話摘要】** FOCIL 這個機制的目的是要對抗「惡意審查」，確保使用者的交易能順利被處理。 它的運作方式很簡單：

1.  每隔一段時間，系統會隨機指派一組糾察隊（IL 委員會）。他們會去看現在有哪些交易正在排隊，然後寫下一份「強制必帶清單 (IL)」。
    
2.  接下來準備出塊的人（還有所有負責投票的驗證者）都要收好這份清單。
    
3.  負責打包區塊的人（Builder），不管你多大牌，你**必須**把你包好的區塊裡，塞進這份清單上的交易。
    
4.  其他的驗證者（Attesters）在投票前會檢查：如果區塊裡沒有包含清單上的交易，他們就**絕對不投票**，讓這個區塊作廢。
    

**【白話動機】** 為什麼要這樣做？因為現在以太坊上，打包區塊的權力都被少數幾個超強的「專業外包商 (Builders)」壟斷了。他們為了賺最多的錢，可能會故意不處理某些人的交易，導致以太坊變得「不公平、容易被審查」。 為了解決這個問題，工程師們想出了「FOCIL」這個點子：既然外包商不乖，那我們就給他戴上緊箍咒，用「強制清單」逼他們一定要處理某些交易，還給以太坊一個公平的環境。
