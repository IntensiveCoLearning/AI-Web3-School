...
在以太坊基金会的分享中，一位专注于隐私领域的专家探讨了零知识证明(ZK)在增强数据隐私和区块链技术中的应用与挑战。他通过比喻和实例，阐述了传统证明机制的局限性，并解释了零知识证明如何在不泄露额外信息的前提下验证事实的真实性，从而解决了隐私保护的难题。专家强调了零知识证明在密码学，数据隐私和区块链扩展性方面的重要潜力，特别是在提升以太坊网络隐私性方面的应用。此外，他提及了零知识身份验证和机器学习隐私保护等具体案例，并呼吁听众深入探索该领域的无限可能，突显了零知识证明技术对未来技术发展的关键作用。
...
\- 角色解析：Issuer（发行者）、Holder（持有者）、Verifier（验证者）
...
\- 机器学习：ZKML，保护模型参数与数据隐私

\- 影像验证：打击假新闻，验证照片真实性

\- 身份验证：ZKID，最小化资料披露

\- 区块链扩容：Layer 2解决方案，提高交易效率

\- 隐私保护工具：如Tornado Cash，争议与双刃剑特性

\- **五、未来展望与学习途径**

\- 欧盟数字身份系统：EUDI，探索零知识证明应用

\- 商业案例：ZK Passport，保护个人隐私

\- 学习资源：ZK Book课程，参与开源项目贡献

\- 风险与挑战：电路设计严谨性，防止伪造与漏洞

\- **六、社区互动与验证方法**

\- 社区支持：技术交流群组，X平台大V互动

\- 验证技巧：检查上传资料，判断是否采用零知识证明
...
\### AI 还能这样用：让 Agent 帮你找机会

\- **引言**

\- 欢迎参加关于如何利用AI发现商业机会的分享会
...
\- 目标设定：明确寻找本地或旅行中的商业机会

\- 工具介绍：使用AI代理进行市场研究

\- 案例分析：以泰国芭提雅市场为例，研究30天内社交媒体上的机会

\- 实践步骤

\- 设定参数：选择城市、语言、预算、合作伙伴数量等

\- 代理引导：通过多轮对话，代理完成市场调研

\- 成果展示：包括潜在供应商、联络方式、推广材料等

\- 技术细节

\- 模型选择：采用GLM模型，支持复杂任务处理

\- 多步骤决策：通过清晰规则指导模型，确保任务连贯性

\- 错误预防：请求工作证明，确保模型输出质量

\- **AI模型使用中的挑战与对策**

\- 长期任务管理

\- 保持焦点：定期提醒模型任务目标，避免偏离

\- 模型切换：遇到难题时，尝试不同模型，提高成功率

\- 数据验证

\- 多维度分析：结合社交媒体数据、用户反馈等，验证信息真实性

\- 避免操纵：通过深度分析，识别潜在的虚假信息

\- 环境与代码问题

\- 环境快照：定期记录系统状态，便于问题定位

\- 自动化测试：要求模型自动生成测试，确保代码质量

\- **结语与建议**

\- 分享与合作

\- 资源分享：提供技能链接和演示材料，鼓励实践探索

\- 持续学习：强调AI领域持续进步，鼓励持续学习和实验

\- 面向未来

\- 长期趋势：展望AI在商业决策中的长远作用

\- 个人发展：鼓励参与者在Hackathon等活动中应用所学，促进个人与团队成长
...
\### AI Agent 深度参与下的区块链应用开发实战

\- **一、区块链技术选择的重新审视**

\- 技术选型的核心问题：在AI Agent时代，是否应采用区块链技术

\- 成本与收益分析

\- 成本：性能与费用、隐私、用户教育成本、开发成本

\- 收益：解决跨系统、跨服务、跨主体的信任问题

\- 成本变化

\- 基础设施改善：性能提升、费用降低、隐私保护技术进步

\- AI Agent作用：降低用户教育成本、简化开发复杂性

\- **二、AI Agent参与下的区块链应用开发实战**

\- 开发复杂性分类：本质复杂性与附属复杂性

\- 开发流程演示

\- 需求确认：使用AI Agent澄清需求，生成设计文件

\- 实现：通过AI Agent执行设计决策，生成代码

\- 调试：提供工具给AI Agent进行前端调试

\- 部署：利用AI Agent自动化部署过程

\- 合约升级：通过AI Agent完成需求确认、实现与部署

\- **三、Complex区块链介绍与应用**

\- Complex特点：高性能、合规供应链、面向国内与海外市场的区块链

\- 应用场景：国内合规场景、联盟链项目、海外EBM兼容环境

\- 技术优势：强大的技术背景、首席科学家与核心工程师团队

\- **四、互动与后续**

\- 问答环节：关于Complex目标用户、市场定位、竞争对手等问题

\- 分享会结束：感谢参与者，提供后续学习资源与联系方式
...
\### AI x Web3 School 例会 Week 3

\- **一、会议流程与目标**

\- 流程说明：会议分为优质笔记分享、黑客松报名与奖励介绍、助教答疑等环节。

\- 目标：鼓励参与者提交高质量笔记，积极参与黑客松比赛，提升项目完成度与团队协作。

\- **二、优质笔记分享**

\- 笔记质量：分享了多篇高质量笔记，包括项目推进、赞助商提问、英文学习记录等。

\- 项目案例：重点介绍了单人参赛者的项目计划，包括产品定义、前端开发、审计提交等。

\- **三、黑客松报名与奖励**

\- 报名情况：已有83名同学报名，组成了9个队伍。

\- 奖项设置：共计20个奖项，包括12个combo赛道和8个ZI赛道，最高奖金800U。

\- 报名截止：13号中午12点前提交项目简介，资料可后续补充。

\- **四、助教与专家资源**

\- 助教经验：过往黑客松冠军将分享经验，通过小范围讨论会形式。

\- 专家邀请：考虑邀请ZI领域的专家进行workshop，需收集问题清单。

\- **五、参赛建议**

\- 团队组建：建议新手抱大腿，加入有经验的团队。

\- 项目准备：强调提交视频或现场演示的准备，避免紧张影响表现。

\- 奖励机制：除了现金奖励，还有可能获得实习机会和生态激励。

\- **六、后续安排**

\- 分享会与答疑：下周仅有一场分享会，剩余为助教答疑会。

\- 报名提醒：强调报名截止日期，鼓励尽早提交项目信息。
...
\- 目标：讨论AI agent在链上执行任务时的钱包权限安全边界与可验证流程

\- 期望：拆解赛道要求，提供可落地的MVP scope

\- **二、产品介绍**

\- 正式环境：官网、API、苹果与安卓应用商店

\- 开发者环境：测试功能，提供自动生成的API文档

\- 产品架构：后端服务、AI agent、skills与CLI

\- MPC钱包技术：多方计算，确保私钥安全

\- **三、技能与CLI使用**

\- Skills安装：复制prompt到agent中，完成钱包安装与配对

\- CLI命令：创建钱包、配对、提交packed

\- API与SDK：提供更底层的访问方式，适用于开发者

\- **四、AI agent与支付**

\- 支付协议：支持AI agent调用付费API或购买服务

\- 交易与投资：利用AI进行defi交易与市场预测

\- 政策市场：AI判断并自动下注确定性高的事件

\- **五、测试与技术支持**

\- 测试流程：开发者环境与生产环境对比

\- 技术支持：加入cobo Jenny wallet群，获取24小时技术支持
